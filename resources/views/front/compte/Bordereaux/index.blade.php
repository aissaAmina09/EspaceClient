                        ...
                        <div class="col-lg-12">
                            <div class="text-center">
                                <ul class="list-inline categories-filter animation-nav" id="filter">
                                    ...
                                    <li class="list-inline-item"><a class="categories" data-filter="*">All</a></li>
                                   
                                    <li class="list-inline-item"><a class="categories active" data-filter=".project">Dossier Architecteure</a></li>
                                    <li class="list-inline-item"><a class="categories" data-filter=".designing">Dossier Génie civil</a></li>
                                    <li class="list-inline-item"><a class="categories" data-filter=".photography">Note de calcule</a></li>
                                    <li class="list-inline-item"><a class="categories" data-filter=".development">Rapport Géotechnique</a></li>
                                     
                                </ul>
                            </div>

                            <div class="row gallery-wrapper" style="position: relative; height: 859.844px;">
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing development" data-category="designing development" style="position: absolute; left: 0px; top: 0px;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/20233.png')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/20233.png')}}" alt="">
                                                <div class="gallery-overlay">
                                                    <h5 class="overlay-caption">Coupes</h5>
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="box-content">
                                            <div class="d-flex align-items-center mt-1">
                                                <div class="flex-grow-1 text-muted">coupes.pdf</a></div>
                                ...
                                <!-- end col -->
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography" data-category="photography" style="position: absolute; left: 403.5px; top: 0px; display: none;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/amenag.png')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/amenag.png')}}" alt="">
                                                <div class="gallery-overlay">
                                ...
                                <!-- end col -->
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography" data-category="photography" style="position: absolute; left: 1210.5px; top: 300.844px; display: none;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/img-8.jpg')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/img-8.jpg')}}" alt="">
                                                <div class="gallery-overlay">
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing development" data-category="designing development" style="position: absolute; left: 597.25px; top: 429.922px;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/img-9.jpg')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/img-9.jpg')}}" alt="">
                                                <div class="gallery-overlay">
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing" data-category="project designing" style="position: absolute; left: 1194.5px; top: 429.922px;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography" data-category="photography" style="position: absolute; left: 807px; top: 601.688px; display: none;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/img-11.jpg')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/img-11.jpg')}}" alt="">
                                                <div class="gallery-overlay">
                                ...
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography" data-category="photography" style="position: absolute; left: 1210.5px; top: 601.688px; display: none;">
                                    <div class="gallery-box card">
                                        <div class="gallery-container">
                                            <a class="image-popup" href="{{asset('assets/images/small/img-12.jpg')}}" title="">
                                                <img class="gallery-img img-fluid mx-auto" src="{{asset('assets/images/small/img-12.jpg')}}" alt="">
                                                <div class="gallery-overlay">
