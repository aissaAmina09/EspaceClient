                ...
                <div class="bg-soft-warning">
                    <div class="card-body pb-0 px-4">
                        ...
                        <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if( $upload == null)  active  @endif  fw-semibold" data-bs-toggle="tab" href="#project-overview" role="tab">
                                      Bon de command{{ $upload}}bb
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if( $upload == null)  active  @endif fw-semibold" data-bs-toggle="tab" href="#project-activities" role="tab">
                                    Aperçu
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-semibold @if( $upload != null)  active  @endif " data-bs-toggle="tab" href="#project-dossiers" role="tab">
                                    Dossier Technique
                                </a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="tab-content text-muted">
                <div class="tab-pane fade @if( $upload != null) show active  @endif" id="project-dossiers" role="tabpanel">
                    ...
                    margin-right: 3px;
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mt-4">
                                            <h5 class="fs-14">Taille :</h5>
                                            <div class="d-flex flex-wrap gap-2">
                                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Out of Stock">
                                                    <input type="radio" class="btn-check" name="productsize-radio" id="productsize-radio1" disabled="">
                                                    <label class="btn btn-soft-primary avatar-xs rounded-circle p-0 d-flex justify-content-center align-items-center" for="productsize-radio1">PDF</label>
                                                </div>

                                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="04 Items Available">
                                                    <input type="radio" class="btn-check" name="productsize-radio" id="productsize-radio2">
                                                    <label class="btn btn-soft-primary avatar-xs rounded-circle p-0 d-flex justify-content-center align-items-center" for="productsize-radio2">IMG</label>
                                                </div>
                                            ...
                                            <div class="p-2 border border-dashed rounded">
                                                <label> <div class="d-flex align-items-center">
                                                 ...
                                                 <div class="flex-grow-1">
                                                        <p class="text-muted mb-1">Dossier Architecteure  :</p>
                                                        <input onclick="m2()" name="m2_CHECK" type="checkbox" id="m2_CHECK"
                                                        {{ old('m2_CHECK') ? 'checked' : '' }}>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="p-2 border border-dashed rounded">
                                                <label>  <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted mb-1">Dossier Génie civil :</p>
                                                        <h5 class="mb-0"><input onclick="m3()" name="m3_CHECK" type="checkbox" id="m3_CHECK"
                                                            {{ old('m3_CHECK') ? 'checked' : '' }}></h5>
                                                    </div>
                                                </div></label> 
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="p-2 border border-dashed rounded">
                                                <label> <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted mb-1"> Note de calcule :</p>
                                                        <h5 class="mb-0"><input onclick="m4()" name="m4_CHECK" type="checkbox" id="m4_CHECK"
                                                            {{ old('m4_CHECK') ? 'checked' : '' }}></h5>
                                                    </div>
                                                </div></label> 
                                            </div>
                                        </div>
                          ...
                          <!--   <label class="text-center">chargement des pièces jointe plan version PDF/Image/DWG: </label>
                            <div class="row text-center">
                                <label> <input onclick="m2()" name="m2_CHECK" type="checkbox" id="m2_CHECK"
                                        {{ old('m2_CHECK') ? 'checked' : '' }}>
                                        Dossier Architecteure </label>&nbsp;&nbsp;
                                <label> <input onclick="m3()" name="m3_CHECK" type="checkbox" id="m3_CHECK"
                                        {{ old('m3_CHECK') ? 'checked' : '' }}>
                                        Dossier Génie civil </label>&nbsp;&nbsp;
                                <label> <input onclick="m4()" name="m4_CHECK" type="checkbox" id="m4_CHECK"
                                        {{ old('m4_CHECK') ? 'checked' : '' }}>
                                        Note de calcule.</label>
                                    <label> <input onclick="m5()" name="m5_CHECK" type="checkbox" id="m5_CHECK"
                                        {{ old('m5_CHECK') ? 'checked' : '' }}>
                                  Maquette.</label>
                            </div> -->
                        </div>
                      ...
                      <button type="submit" id="button" class="btn btn-primary">Envoyer</button>
                        ...
                        <br>
                        <div id="m4" style="display:{{ old('m4_CHECK') ? '' : 'none' }};">
...
@include('front.layouts.scripts.uploadplan')
                ...
                <div class="tab-pane fade  @if( $upload == null)   @endif" id="project-overview" role="tabpanel">
                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body form-steps">
                                                    <form class="vertical-navs-step" action="/uppload/{{$upload}}" method="post" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        @if (count($errors) > 0)
                                                                ...
                                                                <div class="px-lg-4">
                                                                    <div class="tab-content">
                                                                        <div class="tab-pane fade" id="v-pills-bill-info" role="tabpanel" aria-labelledby="v-pills-bill-info-tab">
                                                                            ...
                                                                            <div>
                                                                                <li><a href="{{ route('boncom.showPDF', $upload) }}" class="dropdown-item edit-item-btn"><i class="ri-printer-fill align-bottom me-2 text-muted"></i>
                                                                                    Imprimer</a></li>
                                                                            </div>
