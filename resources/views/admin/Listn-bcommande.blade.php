                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <p class="fw-medium text-muted mb-0">Bon de commande Affecté</p>
                                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{$countAffecte}}">0</span></h2>
                        ...
                        <div class="col-xxl-3 col-sm-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <p class="fw-medium text-muted mb-0">Bon de commande Non affecté</p>
                                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{$counnontAffecte}}">0</span></h2>
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="d-flex align-items-center">
                                        <h5 class="card-title mb-0 flex-grow-1">Recherche</h5>
                                    </div>
                                    <div class="collaps collapse show" id="collapseExample" style="">
                                        <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3 g-3">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" placeholder="Search intitulé projet ,bureau etude , maitre d'ouvrage " autocomplete="off" id="searchProductList">
                                            </div>
                                            <div class="col">
                                                <h6 class="text-uppercase fs-12 mb-2">Select Wilaya </h6>
...
@endforeach
                                            ...
                                            <div class="col">
                                                <h6 class="text-uppercase fs-12 mb-2">Search</h6>
                                                <a class="btn btn-success" data-bs-toggle="collapse" href="" aria-expanded="true"><i class="ri-filter-2-line align-bottom"></i> Rchercher</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="alert alert-warning alert-borderless" role="alert">
                        <strong> Bonjour ! </strong> {{$errors->first()}}
                    </div>
                    @endif
                            <div class="card-body">
                                            ...
                                            <table id="example"
                                                ...
                                                : activate to sort column descending">
                                                        ...
                                                        <th data-ordering="false" class="sorting" tabindex="0"
                                                            aria-controls="example" rowspan="1" colspan="1"
                                                            style="width: 147.4px;"
                                                            aria-label="User: activate to sort column ascending">Ing ControlleSite
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="example"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="odd"  @if ($use->codeAffaire !='NULL')
                                                  
                                                        style="background-color:#91e8dc5e"
                                                        @else 
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge bg-success"> {{$dd->nom_wilaya}}</span>
                                                               @endif
                                                             @endforeach
                                                        </td>
                                                        ...
                                                        <td style="">
                                                            <div class="dropdown d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                  <li><a href="{{  asset('documentsigne/'.$use->docSig)}}.pdf"target="_blank" class="dropdown-item"><i
                                                                                class="ri-eye-line align-bottom me-2 text-muted"></i>
                                                                                Visualisation document</a></li>
                                                                                @if($use->codeAffaire =='NULL' )    
                                                                                        <li><button data-info="{{ $use }}"
                                ...
                                @endif
                                                                                    ...
                                                                                    <li><a href=""data-bs-toggle="modal"  class="dropdown-item"><i
                                                                                        class=" ri-send-plane-fill align-bottom me-2 text-muted"></i>
                                                                                        Renseiegnement  Affaire</li>
</a></li>
                                                                                    <li><a href="{{ url('DetaillProjet_Admin',$use->code)}}" class="dropdown-item"><i
                ...
                <div class="modal fade zoomIn" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-0">
                            ...
                            <form action="{{route('affectaion_affaire')}}"class="test_form" method="POST"enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                <div class="modal-body">
                                    <input type="hidden" id="tasksId" />
                                    <div class="row g-3"><input id="feed_id" name="codeBC" type="hidden" />
                                        <!--end col-->
                                        <div class="col-lg-12">
                                            <label class="form-label">Affecter  vers Agence </label>
                                            <select id="code_ag" name="code_ag" data-choices data-choices-search-false id="ticket-status"
                                            class="browser-default custom-select">
                                            @foreach(App\Bagence::whereIN('code_ag', ['161','162','164','165','168','169'])->get() as $role)
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">Affecter</button>
                                    </div>
                                </div>
                            </form>
                        </div>
