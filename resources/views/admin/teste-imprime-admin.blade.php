            ...
            <div class="container-fluid pt-2 pt-md-4 px-md-5">
                <!-- Invoice <div style="width: 210mm; height: 297mm">--><!-- Invoice items table -->
                        @if($bcommande->count()>0) @foreach($bcommande as $use) <table class="table">
                            ...
                            <TR style="outline: thin solid">
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" width="33%">Intitulé
                                    du Projet : </th>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" width="33%"
                            ...
                            <TR>
                                <th scope="col" rowspan="4"
                                    ...
                                    <br>
                                    <center>Maitre d’œuvre :
                                </Th>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" colspan="2"><span
                                        style="font-size:11pt; color: #000; font-family: 'Arial', 'Open Sans', sans-serif;font-style: italic;">Dénomination
                                        :</span>&ensp;
                                ...
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" rowspan="9">
                                    <table class="table" style="box-sizing: content-box !important;">
                                        <tr>
                                            <th rowspan="3">
                                                <p class="">Avancement des études à la date du bon de commande</p>
                                                </td>
...
">take up space on
                                        ...
                                        <tr>
                                            <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;">Projet
                                                <br>d'exécution
                                                <br>
                                                <center><input type="checkbox" @if ($use->Projetdexécution=="1") {
                                                    {{'checked'}}
                            ...
                            <tr>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;"><span
                                        style="font-size:11pt; color: #000; font-family: 'Arial', 'Open Sans', sans-serif;font-style: italic;">Tél
                                        :</span>&ensp;
                            ...
                            <tr>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" colspan="2"><span
                                        style="font-size:11pt; color: #000; font-family: 'Arial', 'Open Sans', sans-serif;font-style: italic;">Tél-Fax-Email
                                        :</span>&ensp;
                            ...
                            <tr>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" colspan="2"><span
                                        style="font-size:11pt; color: #000; font-family: 'Arial', 'Open Sans', sans-serif;font-style: italic;">Ingénieur
                                        Chargé de l'Etude G.Civil:&ensp;</span>{{$use->IngControlleSite}} </td>
                            </tr>
                            <tr>
                                <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;" colspan=""><span
                                        style="font-size:11pt; color: #000; font-family: 'Arial', 'Open Sans', sans-serif;font-style: italic;">Numéro
                                        d'agrement:(tableau des Ingénieurs) :</span></td>
                            ...
                            <TR>
                                <th scope="col" rowspan="5"
                                    style="outline: thin solid ;padding: 0 10px;padding: 0 10px;font-size: 18px;width:20%;width=33% ">
                                    <br>
                                    <center>Laboratoire Etudes<br>de Sol <br>(Géotechnique) :</center>
                                </th>
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th style="font-size: 17px;">
                                        <center>Date prévisionnelle <br>du début des travaux :  {{$use->DateDebuttravaux}}
                                            

                                        </center>
                                    </th>
                                    <th colspan="2" style="font-size: 17px;">
                                        <center>Délais des Travaux <br>en Mois: 
                                                {{$use->DateDélaisTravaux}}
                                ...
                                <tr style="outline: thin solid">
                                    <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;">
                                        <center>Désignation du Bâtiment <br>et/ou Ouvrage </center>
                                    </th>
                                    <th style="outline: thin solid ;padding: 0 10px;font-size: 18px;">
                                        <center>Emprise du Bâtiment <br>et /ou Ouvrage <br>au Sol en M² </center>
                                    </th>
                                    <th style="outline: thin solid;padding: 0 10px;font-size: 15.5px;">
                                        <center>Nombre d’Etages du<br>Bâtiment<br>et/ou Hauteur de l’ouvrage</center>
                                    </th>
                                    <th style="outline: thin solid;padding: 0 10px;font-size: 18px;">
                                    ...
                                    <td style="outline: thin solid ;padding: 0 10px;font-size: 17px;">
                                        ...
                                        <th style="outline: thin solid" colspan="2">
                                            <center>Authentification par le Maitre d’œuvre <br>Date,
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th
                                        ...
                                        <h5 class="mb-1">
                                            <center>Reçu le</center>
                                        </h5><br><br><br></td>
                                    <th style="border-bottom:1px solid white; border-right:1px solid black"
                                        width="200px;">
                                        <h5 class="mb-1">
                                            <center>Vérifié par</center>
                                        </h5><br><br><br></td>
                                    <th style="border-bottom:1px solid white; border-right:1px solid black">
                                        <h5 class="mb-1">
                                            <center>Décision du Directeur d’Agence</center>
                                        </h5><br><br><br></td>
                                    <th style="border-bottom:1px solid white; border-right:1px solid black"
                                        class="font-weight-bold align-middle text-right text-nowrap">
                                        <center>Visa Direction Régionale</center><br><br><br></td>
                                </tr>
                            </table>
