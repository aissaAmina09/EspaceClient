        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">Réclamation</div>
 ...
 Inscrits</h2>
                        ...
                        <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <!--afficher tt  les client par wilaya selon le role  super admin  --->  
                            @if ($user->role_id == 1) 
...
<td> @if($client->is_activated)
                         ...
                         <span class="label label-warning">Inactifs</span>
                          ...
                          @endif</td>
                                      ...
                                      @endforeach
  <!--afficher tt client par wilaya selon  la Structure  ---> 
                                      @else
                                      ...
                                      @foreach(\App\User::where('wilaya','=',$str)->orderby('created_at','desc')->take(5)->get() as $client)
  ...
  $(function(){
      ...
      var options = {
        ...
        title: {
          display: true,
          position: "top",
          text: " le nbr Clients par wilaya",
          fontSize: 18,
          fontColor: "#111"
        },
        legend: {
