                                    ...
                                    <div class="col-xxl-9">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <!-- Swiper -->
                                                <div class="swiper project-swiper mt-n4 swiper-initialized swiper-horizontal swiper-pointer-events">
                                                    <div class="d-flex justify-content-end gap-2 mb-2">
                                                        <div class="slider-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-71c9d16098414006" aria-disabled="true">
                                                            <div class="avatar-title fs-18 rounded px-1">
                                                                <i class="ri-arrow-left-s-line"></i>
                                                            </div>
                                                        </div>
                                                        <div class="slider-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-71c9d16098414006" aria-disabled="false">
                                                            <div class="avatar-title fs-18 rounded px-1">
                                                                <i class="ri-arrow-right-s-line"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="swiper-wrapper" id="swiper-wrapper-71c9d16098414006" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                                        <div class="swiper-slide swiper-slide-active" style="width: 433px; margin-right: 20px;" role="group" aria-label="1 / 5">
                                                        ...
                                                        <!-- end slide item -->
                                                        <div class="swiper-slide swiper-slide-next" style="width: 433px; margin-right: 20px;" role="group" aria-label="2 / 5">
                                                        ...
                                                        <div class="swiper-slide" style="width: 433px; margin-right: 20px;" role="group" aria-label="3 / 5">
                                                        ...
                                                        <div class="swiper-slide" style="width: 433px; margin-right: 20px;" role="group" aria-label="4 / 5">
                                                            <div class="card profile-project-card shadow-none profile-project-danger mb-0">
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div class="flex-grow-1 text-muted overflow-hidden">
                                                        ...
                                                        <!-- end slide item -->
                                                        <div class="swiper-slide" style="width: 433px; margin-right: 20px;" role="group" aria-label="5 / 5">
