               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;important!">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                            Liste des Notifications  Nouveaux client envoyé au Client:
                                <span style="font-size:21px;font-weight:bold; color:#F44336;"> 
                                <?php $client=App\Notification::where('type', 'App\Notifications\NouveauxClients')
                               ->count();?>{{$client}}</span></h2>
                            </h2>
                        </div>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach(App\Notification::where('type', 'App\Notifications\NouveauxClients')->get() as $notif)
                                <tbody>
                                    <tr>
                                        <td>
                                        @foreach(App\Buser::get() as $not)
