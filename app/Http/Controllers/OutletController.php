...
class OutletController extends Controller
{
    ...
    public function index()
    {
         ...
         //$outlet = DB::table("b_bcommandes")->select("latitude","longitude")->get();
        $outletQuery = B_bcommande::query();
        $outletQuery->select("latitude","longitude");
         $outlet = $outletQuery->paginate(25);
     
       
        return view('admin.testeOutlet')->with('outlet', $outlet);
